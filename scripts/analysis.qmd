...
author: "Group 4: Tom Suo 2549787, Lucy Liu 2561533, Leo Xu 2592825, Mike Wu 2549432, Santiago Vazquez 2592291"
format:
  html:
    code-fold: true
  pdf:
...
plt.tight_layout()
plt.savefig('../figures/Correlation Matrix of Key Economic Indicators.png')
plt.show()
```
...
Between 2017 and 2023, the selected European economies demonstrated a three-tiered response to major shocks, stratified by existing wealth and structural characteristics. Norway and the United Kingdom, representing high-income economies, exhibited stability and rapid recovery; Norway’s GDP per capita ($75k–$80k range) showed only a minor fluctuation in 2020, and its employment ratio quickly surpassed pre-pandemic levels by 2022. Italy and Portugal, occupying the middle-income band, experienced synchronized contractions in GDP per capita and GDP growth in 2020, followed by consistent, moderate recovery through 2023. Albania and Ukraine, the emerging economies, displayed the greatest divergence, with Albania demonstrating a strong employment resurgence but Italy showing a significant post-2020 rise in out-of-school children, indicating uneven socioeconomic impacts. The GDP Growth analysis confirmed a deep, synchronized drop for all nations in 2020, with Italy and the UK hit hardest. The correlation matrix quantifies structural links: GDP per capita correlates positively with employment ratio, +0.65, and both correlate negatively with children out of school, –0.45 and –0.35, respectively.
...
Sustaining economic stability through global disruptions requires structural resilience, not merely volatile growth. Our findings confirm that advanced economies, characterized by high GDP per capita and strong labor markets, possess the necessary capital and policy infrastructure to rapidly recover from global shocks. However, this study also highlights a critical vulnerability: while recovery in GDP and employment was widespread, the socioeconomic health of nations, measured by educational access, remains inconsistent. The negative correlation between income and out-of-school children confirms that development progress is holistic; therefore, future policy interventions must be designed not just to boost GDP, but to shield vulnerable populations and social institutions, like education, to ensure that economic resilience is shared and sustained across all layers of society. The experience of Ukraine provides a final, stark reminder that stable development is fundamentally dependent on geopolitical stability, an essential prerequisite that dwarfs the economic effects of all other crises.