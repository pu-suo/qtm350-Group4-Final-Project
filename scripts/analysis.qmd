...
The GDP per capita are distincly separated into three groups based on the economic groups that the countries fall under. This shows the different level of shock each group of countries experienced based on there economical prowess before the pandemic.

High Income Stability: Norway and the United Kingdom occupy the upper tier economic powers of the analysis. Norway exhibits exceptional stability where the 2020 pandemic shock appears as a minor fluctuation against its high baseline wealth (approx. \$75k–\$80k), followed by a return to gradual growth. The United Kingdom displays a V shaped impact in 2020 where the GDP droped toward \$42k before recovering. However, the UK's trajectory notably flattens post 2022, suggesting a slowing of momentum in the post-pandemic recovery phase compared to Norway's steady rise.

Southern European Parallels: Italy and Portugal follow strikingly parallel paths in the middle income band. Both nations show clear, synchronized contractions in 2020 likely driven by the vulnerability of their service and tourism oriented sectors to lockdowns. Their recovery from 2021 to 2023 has been consistent and positive, with both lines trending upward in unison, though neither shows signs of aggressive expansion beyond prepandemic trends.
...
legend_handles = [
    plt.Rectangle((0, 0), 1, 1, fc="steelblue", edgecolor='black'),
    plt.Rectangle((0, 0), 1, 1, fc="red", edgecolor='black')
]
legend_labels = ['Pre-COVID (2017-2019)', 'Post-COVID (2020 Onwards)']
...
The grid of bar charts reveals the different trends in the number of primary (K-12) out-of-school children for each country, emphasizing that the post-2020 period [highlighted in red] varied for each country. The pandemic acted more as a stress test than an actual shock to European education systems. 
